        ...
        <div class="card-body">
            ...
            <div class="row mb-3">
                <div class="col-12 text-start">
                    ...
                    <br>
                    <p>Nombre de la evaluación: <?=$valoracion_evaluacion['cve_proyecto']?> - <?=$valoracion_evaluacion['nom_proyecto']?></p>
                </div>
            </div>
            <div class="row mb-3">
            ...
            <div class="row mb-3 text-start">
                ...
                <p>Le comento que se ha llevado a cabo la revisión del Informe final de la evaluación <?=$valoracion_evaluacion['nom_proyecto']?> aplicada al programa <?=$valoracion_evaluacion['nom_programa']?>, misma que fue realizada por <?=$valoracion_evaluacion['nom_evaluador']?>.</p>

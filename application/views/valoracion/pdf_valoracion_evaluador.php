    ...
    <div class="card mt-3 mb-3 d-print-none">
        ...
        <div class="card-body">
            ...
            <?php
                $prefijo = 'val_evd' ;
                $tipo_archivo = 'pdf';
                $nombre_archivo = $prefijo . '_' . $valoracion_evaluador['id_valoracion_evaluador'] . '.' . $tipo_archivo;
                $dir_docs = './doc/';
                $url_actual = base_url() . 'valoracion/valoracion_evaluador_detalle/' . $valoracion_evaluador['id_valoracion_evaluador'] ;
                $descripcion = 'val evaluador';

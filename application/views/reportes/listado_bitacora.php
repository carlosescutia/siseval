<main role="main" class="ml-sm-auto px-4 mb-3 col-print-12">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <div class="col-sm-12 alternate-color">
            <form method="post" action="<?= base_url() ?>reportes/listado_bitacora">
                <div class="row">
                    <div class="col-sm-8 text-start">
                        <h1 class="h2">Bitácora de actividad</h1>
                    </div>
                    <div class="col-sm-4 text-end d-print-none">
                        <button formaction="<?= base_url() ?>reportes/listado_bitacora/csv" class="btn btn-primary">Exportar a excel</button>
